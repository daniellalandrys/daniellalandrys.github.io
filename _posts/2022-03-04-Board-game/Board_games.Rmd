...
description: Dans cet article, je vais analyser des données issues de Tidy Tuesday
  dénommé Board Games Database. Je vais tenter de répondre à la question de savoir
  est ce que le nombre de joueurs ainsi que le temps passé à jouer influencent-ils les notes données? 
---
...
```
Dans cet article, je vais analyser des données issues de [Tidy Tuesday](https://rpubs.com/thewiremonkey/476630)
  dénommé Board Games Database. Je vais tenter de répondre à la question de savoir
  est ce que le nombre de joueurs ainsi que le temps passé à jouer influencent-ils les notes données? 
